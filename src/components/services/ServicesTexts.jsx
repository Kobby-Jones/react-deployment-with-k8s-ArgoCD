const services = {
  rentAndSell: {
    ...
    text: "Our Renting and Selling Services cater to the needs of both buyers and sellers. We offer a range of marketing and advertising services to help you sell or rent your property quickly and at the best possible price. Our team conducts thorough property evaluations, helps you with property staging, and provides expert advice on pricing strategy. We also provide comprehensive buyer representation services to help you find the perfect property at the best possible price.",
  },
  propertyManagement: {
